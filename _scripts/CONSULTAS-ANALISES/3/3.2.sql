...
IF EXISTS (SELECT 1 FROM sys.Objects WHERE  Object_id = OBJECT_ID(N'[SP_ANALISE3_2]') AND Type = N'P')
BEGIN
   DROP PROCEDURE SP_ANALISE3_2
END
GO

CREATE PROCEDURE SP_ANALISE3_2(
	@ANO INT = NULL,
