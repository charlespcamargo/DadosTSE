...
SELECT 
	...
	SELECT 
	   TDLocalidade.ID,TDLocalidade.Municipio, TDLocalidade.SiglaEstado,
	   SUM(CASE 
	   ...
	   COUNT(1) AS QtdTotal
		...
		GROUP BY 
		   TDLocalidade.ID, TDLocalidade.Municipio, TDLocalidade.SiglaEstado) RESULTADO
		   
	   ORDER BY QtdFeminino DESC