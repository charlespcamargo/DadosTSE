...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges" style="width:200px;">' +
                  '<div class="range_inputs">' +
                    ...
                    '</div>' +
                    '<div><button id="btnClearDate" class="btn " disabled="disabled" style="width:60px;">' + this.locale.clearLabel + '</button>' +
                    '<button class="btn " disabled="disabled" style="width:60px; margin-left:10px;">' + this.locale.applyLabel + '</button></div>' +
                  '</div>' +
                '</div>' +
              '</div>';
        ...
        this.container.find('.ranges').on('click', 'button', $.proxy(this.clickClear, this));
    ...
    DateRangePicker.prototype = {
        ...
        clickClear: function (e) {
            if ($(e.target).attr("id") == "btnClearDate") {
                if (this.element.is('input')) {
                    this.element.val("");
                }
            }
