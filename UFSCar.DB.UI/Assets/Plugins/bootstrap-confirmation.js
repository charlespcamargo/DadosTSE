	...
	* ======================= */
	...
	$.fn.confirmation.defaults = $.extend({} , $.fn.tooltip.defaults, {
		...
		, template: '<div class="popover">' +
				...
				'<div class="btn-group">' +
				'<a class="btn finalizar" href="" target=""></a>' +
				'<a class="btn cancelar" data-dismiss="confirmation"></a>' +
				'</div>' +
				'</div>' +
				'</div>'
		, btnCancelClass:  ''
		, btnOkLabel: 'SIM | <i class="icon-ok-sign"></i>'
		, btnCancelLabel: 'NÃO | <i class="icon-remove-sign"></i>'
		, singleton: false
		, popout: false
		, onConfirm: function(){}
		, onCancel: function(){}
