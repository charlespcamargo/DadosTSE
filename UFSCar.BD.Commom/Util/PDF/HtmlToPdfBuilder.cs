...
namespace UFSCar.BD.Commom.PDF
{
    ...
    public class HtmlToPdfBuilder
    {
        ...
        //#region "Download na Tela"

        //public void Exporta(HttpResponse Response, String NomeArquivo)
        //{
        //    Exportacao.ExportaPdf(this.RenderPdf(), Response, NomeArquivo);
        //}
